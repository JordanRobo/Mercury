...
// src/client.ts
var MERCURY_API_URL = Bun.env.MERCURY_API_URL || "http://127.0.0.1:2323/api";
...
var client_default = MercuryClient;

// src/posts/posts.ts
class PostsAPI extends client_default {
  constructor() {
    super(...arguments);
  }
  async getPosts() {
  ...
  async updatePost(post) {
    try {
      const response = await this.client.patch(`/posts/${post.id}`, post);
      return response.data;
    } catch (error) {
...
var posts_default = PostsAPI;
export {
  posts_default as PostsAPI
};
